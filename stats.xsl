...
<xsl:template match="/pokedex">
    Strong attackers: <xsl:value-of select="count(//pokemon[number(attack/text()) > 150])" />
...
<xsl:template match="/pokedex">
  <html>
  <body>
  <h2>Strong Attackers: <xsl:value-of select="count(//pokemon[number(attack/text()) > 150])" /></h2>
  <table border="1">
    <tr bgcolor="#9acd32">
      <th>Name</th>
      <th>Type</th>
  ...
  <h2>Strong Defenders: <xsl:value-of select="count(//pokemon[number(attack/text()) > 150])" /></h2>
  <table border="1">
    <tr bgcolor="#9acd32">
      <th>Name</th>
      <th>Type</th>
  ...
  <h2>Fast: <xsl:value-of select="count(//pokemon[number(speed/text()) > 150])" /></h2>
  <table border="1">
    <tr bgcolor="#9acd32">
      <th>Name</th>
      <th>Type</th>
